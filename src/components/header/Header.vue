<template>
  <header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
    <div class="flex items-center">
      <button @click="emit('openSidebar2')" class="text-gray-500 focus:outline-none lg:hidden">
    ...
    <div class="flex items-center">
      <!-- <div v-data="{ notificationOpen: false }" class="relative">
        ...
        <div
          v-cloak
          v-show="notificationOpen"
          class="notification absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80"
          style="width: 20rem"
        >
          <RouterLink
            to="#"
          ...
          >
            ...
            <p class="mx-2 text-sm">
              <span class="font-bold" to="#">Sara Salah</span> replied on the
              <span class="font-bold text-indigo-400" to="#">Upload Image</span> artical . 2m
            </p>
          </RouterLink>
          <RouterLink
            to="#"
          ...
          >
            <img
              ...
              alt="avatar"
            />
            <p class="mx-2 text-sm"><span class="font-bold" to="#">Slick Net</span> start following you . 45m</p>
          </RouterLink>
          <RouterLink
            to="#"
            class="flex items-center px-4 py-3 -mx-2 text-gray-600 hover:text-white hover:bg-indigo-600"
          >
            ...
            />
            <p class="mx-2 text-sm">
              <span class="font-bold" to="#">Jane Doe</span> Like Your reply on
              <span class="font-bold text-indigo-400" to="#">Test with TDD</span> artical . 1h
            </p>
          </RouterLink>
          <RouterLink
            to="#"
